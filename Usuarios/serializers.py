...
class UserEmployeeSerializer(serializers.ModelSerializer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password'] = serializers.CharField(required=False, allow_null=True, allow_blank=True)
        self.fields['email'] = serializers.EmailField(required=True, allow_null=False, allow_blank=False)
        self.fields['ine_frente'] = serializers.ImageField(required=True, allow_null=False, allow_blank=False)
        self.fields['ine_atras'] = serializers.ImageField(required=True, allow_null=False, allow_blank=False)
        self.fields['avatar'] = serializers.ImageField(required=True, allow_null=False, allow_blank=False)
