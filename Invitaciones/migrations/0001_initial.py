...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fecha_hora_envio', models.DateTimeField(default=datetime.datetime(2019, 9, 25, 1, 16, 23, 263609, tzinfo=utc))),
                ('typeInv', models.IntegerField(default=0)),
                ('dateInv', models.DateField(default=datetime.date(2019, 9, 26))),
                ('timeInv', models.TimeField(default=datetime.time(0, 0))),
                ('expiration', models.DateField(default=models.DateField(default=datetime.date(2019, 9, 26)))),
