    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('urlVideo', models.CharField(max_length=300, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateInv', models.DateField()),
                ('timeInv', models.TimeField()),
                ('expiration', models.DateField(default=datetime.date(2019, 10, 21))),
                ('diary', models.CharField(default='', max_length=7)),
                ...
                ('Token', models.CharField(default='649b173239ad74', max_length=14)),
